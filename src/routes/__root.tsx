...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "icon",
        href: "/bella-allegri-seal-icon.png",
        type: "image/png",
        sizes: "96x96",
      },
      {
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "Organization",
              "@id": "https://bmallegri.com/#organization",
              name: "Bella Michele Allegri",
              alternateName: "BMAllegri",
              url: "https://bmallegri.com",
              logo: {
                "@type": "ImageObject",
                "@id": "https://bmallegri.com/#logo",
                url: "https://bmallegri.com/logo.png",
                contentUrl: "https://bmallegri.com/logo.png",
                width: 1200,
                height: 1200,
                caption: "BMAllegri seal logo",
              },
              image: { "@id": "https://bmallegri.com/#logo" },
            ...
            {
              "@type": "WebSite",
              "@id": "https://bmallegri.com/#website",
              url: "https://bmallegri.com",
              name: "Bella Michele Allegri",
              inLanguage: "en",
              publisher: { "@id": "https://bmallegri.com/#organization" },
            },
          ],
        }),
      },
