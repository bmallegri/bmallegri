...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://bmallegri.com/" },
    ...
    links: [{ rel: "canonical", href: "https://bmallegri.com/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Person",
          "@id": "https://bmallegri.com/#person",
          name: "Bella Michele Allegri",
          jobTitle: "Student Researcher",
          url: "https://bmallegri.com",
          image: "https://bmallegri.com/logo.png",
          mainEntityOfPage: "https://bmallegri.com/",
          sameAs: [
